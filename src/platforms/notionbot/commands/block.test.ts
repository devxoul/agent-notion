...
describe('block commands', () => {
  ...
  test('append sends block children to parent', async () => {
    ...
    // Then
    expect(mockAppendBlockChildren).toHaveBeenCalledWith('parent-456', children, undefined)
    const output = JSON.parse(consoleOutput[0])
  ...
  test('append with --after passes after to appendBlockChildren', async () => {
    ...
    // Then
    expect(mockAppendBlockChildren).toHaveBeenCalledWith('parent-456', children, 'sibling-1')
  })
  ...
  test('append chunks >100 blocks via client.appendBlockChildren', async () => {
    ...
    expect(mockAppendBlockChildren).toHaveBeenCalledWith('parent-789', children, undefined)
  })
  ...
  test('append with --after and --markdown', async () => {
    ...
    // Then
    expect(mockAppendBlockChildren).toHaveBeenCalledWith('parent-456', expect.any(Array), 'sibling-1')
  })
  ...
  test('upload calls uploadFile and outputs result', async () => {
    ...
    // Then
    expect(mockUploadFile).toHaveBeenCalledWith(expect.anything(), 'parent-123', './test.png', undefined)
    const output = JSON.parse(consoleOutput[0])
  ...
  test('upload with --after passes after to uploadFile', async () => {
    ...
    // Then
    expect(mockUploadFile).toHaveBeenCalledWith(expect.anything(), 'parent-123', './test.png', 'sibling-1')
  })
